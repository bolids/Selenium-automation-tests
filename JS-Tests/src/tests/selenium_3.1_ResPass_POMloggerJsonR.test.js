...
describe('Selenium Tests - Auth to App', () => {
    ...
    it('Reset password FE worm validation - PageObject', async () => {
        ...
        log.info("ACTUAL FormName: " + actualtForgPasFormName);
        ...
        log.info("isEnabledCheckSubmitBtn: " + actualsubmitBtnResetPE.toString());
    ...
    it('Reset password BE checks - Reset Password Success page checks - PageObject', async () => {
        ...
        log.info("Open URL");
        await loginPage.open();
        log.info("Click on Forgot passw btn and navigate to reset password page");
        await loginPage.pressForgotPasswBtn(); //click on Forgot passw btn and navigate to reset password page
        log.info("Reset Password Form Checks");
        ...
        log.info("ACTUAL FormName: " + actualResetPasFormName);
