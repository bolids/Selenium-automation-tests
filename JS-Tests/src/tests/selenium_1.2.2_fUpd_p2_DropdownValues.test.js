...
import { expect, jest, it, afterEach, beforeEach, beforeAll, afterAll, async } from '@jest/globals';
...
describe('Auth to app > My contact details updating and updates checking', () => {
    ...
    it('Contact details updating and verifying test', async () => {
        ...
        const selectedCountry ="//div[@class='oxd-select-text-input']";
        const expandListCountry = "//div[starts-with(@class, oxd-grid-item')]//i";
        const listItem = "//div[@role= 'listbox']//*[text()= 'Ukraine']";
        await new Promise(r => setTimeout(r, 1000));
        await driver.findElement(By.xpath(selectedCountry)).click();
        await new Promise(r => setTimeout(r, 1000));
        await driver.findElement (By.xpath(listItem)).click();
        await new Promise(r => setTimeout(r, 1000));
